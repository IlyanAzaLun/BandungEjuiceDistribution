...
<ul class="nav nav-pills nav-sidebar flex-column nav-legacy" data-widget="treeview" role="menu" data-accordion="false">
  ...
  <li class="nav-item has-treeview <?php echo ($page->menu=='Purchase')?'menu-open':'' ?>">
    ...
    <ul class="nav nav-treeview">
      <li class="nav-item">
        <a href="<?php echo url('invoice/purchase/view') ?>" class="nav-link <?php echo ($page->submenu=='view')?'active':'' ?>">
          <i class="far fa-circle nav-icon"></i> <p>  <?php echo lang('purchase_list') ?> </p>
        </a>
      </li>
      <li class="nav-item">
        <a href="<?php echo url('invoice/purchase/create') ?>" class="nav-link <?php echo ($page->submenu=='create')?'active':'' ?>">
          <i class="far fa-circle nav-icon"></i> <p> <?php echo lang('purchase_create') ?> </p>
        </a>
      </li>
    </ul>
  </li>
    ...
    <ul class="nav nav-treeview">
      <li class="nav-item">
        <a href="<?php echo url('items/list') ?>" class="nav-link <?php echo ($page->submenu=='list')?'active':'' ?>">
          <i class="far fa-circle nav-icon"></i> <p>  <?php echo lang('item_list') ?> </p>
        </a>
      </li>
      <li class="nav-item">
        <a href="<?php echo url('items/add') ?>" class="nav-link <?php echo ($page->submenu=='add')?'active':'' ?>">
          <i class="far fa-circle nav-icon"></i> <p> <?php echo lang('item_add') ?> </p>
        </a>
      </li>
    </ul>
  </li>
    ...
    <ul class="nav nav-treeview">
      <li class="nav-item">
        <a href="<?php echo url('master_information/customer/list') ?>" class="nav-link <?php echo ($page->submenu=='list')?'active':'' ?>">
          <i class="far fa-circle nav-icon"></i> <p>  <?php echo lang('customer_list') ?> </p>
        </a>
      </li>
      <li class="nav-item">
        <a href="<?php echo url('master_information/customer/add') ?>" class="nav-link <?php echo ($page->submenu=='add')?'active':'' ?>">
          <i class="far fa-circle nav-icon"></i> <p> <?php echo lang('customer_add') ?> </p>
        </a>
      </li>
    </ul>
  </li>

    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <!-- /.card-header -->
            <?php echo form_open_multipart('master_information/customer/edit?id='.$customer->id, [ 'class' => 'form-validate', 'autocomplete' => 'off' ]); ?>
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <!-- text input -->
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="customer_code" id="customer_code" readonly value="<?=$customer->customer_code?>">
                        </div>
                    </div>
                    ...
                    <!-- text input -->
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="store_name" id="store_name" value="<?=$customer->store_name?>" required>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="row">
                        ...
                        <!-- text input -->
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="owner_name" id="customer_owner" value="<?=$customer->owner_name?>" required>
                    ...
                    <!-- text input -->
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control" name="note" id="note"><?=$customer->note?></textarea>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools pull-right">
                    <a href="<?=url('master_information/address/add?id='.$customer->id)?>" type="button" class="btn btn-block btn-default"><i class="fa fa-plus"></i></a>
                </div>
            </div>
            <div class="card-body">
                <table class="table table-sm table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?=($value->is_active)?'Open':'Closed'?></td>
                            <td>

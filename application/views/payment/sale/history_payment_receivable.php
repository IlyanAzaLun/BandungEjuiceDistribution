  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-12">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-2 col sm-12"><b><?=lang('note')?></b></div>
              ...
              <td>
                <div class="row">
                  ...
                  <div class="col-md-1 col sm-12">
                    ...
                    <?php if($key+1 != sizeof($response_data)):?>
        ...
        <?php $this->info['customer'] = $this->customer_model->getByWhere(array('customer_code' => $response_data[0]->customer_code));?>
        <div class="card">
            <div class="card-header">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-2 col-sm-12">
                      <span class="float-right">
                          <h6><?=lang('customer')?>:</h6>
                          <b><?=$this->info['customer'][0]->store_name?> / <?=$this->info['customer'][0]->owner_name?></b>
                      </span>
                  </div>
                  <div class="col-lg-2 offset-lg-4 col-sm-12">
                      <span class="float-right">

...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo $url->assets ?>index2.html"><b>Admin</b>LTE</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <p class="mb-1">
        <a href="<?php echo url('adminlte/examples/forgot_password') ?>">I forgot my password</a>
      </p>
      <p class="mb-0">
        <a href="<?php echo url('adminlte/examples/register') ?>" class="text-center">Register a new membership</a>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>

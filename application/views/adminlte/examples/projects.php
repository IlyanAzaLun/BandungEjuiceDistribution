                      ...
                      <td>
                          <ul class="list-inline">
                              <li class="list-inline-item">
                                  <img alt="Avatar" class="table-avatar" src="<?php echo $url->assets ?>img/avatar.png">
                              </li>
                              <li class="list-inline-item">
                                  <img alt="Avatar" class="table-avatar" src="<?php echo $url->assets ?>img/avatar2.png">
                              </li>
                              <li class="list-inline-item">
                                  <img alt="Avatar" class="table-avatar" src="<?php echo $url->assets ?>img/avatar3.png">
                              </li>
                              <li class="list-inline-item">
                                  <img alt="Avatar" class="table-avatar" src="<?php echo $url->assets ?>img/avatar04.png">
                              </li>
                          </ul>
                      </td>
                  ...
                  <tr>
                      ...
                      <td>
                          <ul class="list-inline">
                              ...
                              <li class="list-inline-item">
                                  <img alt="Avatar" class="table-avatar" src="<?php echo $url->assets ?>img/avatar5.png">
                              </li>
                          </ul>
                      </td>
                      <td class="project_progress">

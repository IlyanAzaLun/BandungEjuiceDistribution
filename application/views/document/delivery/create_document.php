          ...
          <div class="row">
            <div class="col-lg col-sm-12">
              <div class="form-group">
                ...
                <input type="text" name="customer_code" id="customer_code" class="form-control" placeholder="<?= lang('find_customer_code') ?>" autocomplete="false" required value="<?=$invoice->customer?$invoice->customer:$invoice->supplier;?>">
                ...
                <?php foreach ($item_list as $key => $value): ?>
                  <tr class="input-<?=$key?>" id="main">
                    ...
                    <td>
                      ...
                      <input readonly class="form-control form-control-sm" type="text" name="item_code[]" data-id="item_code" required value="<?=$value->item_code?>">
                    </td>
                    ...
                    <td><input readonly class="form-control form-control-sm" type="text" data-id="note" value="<?=$value->item_description?>"></td>
                    <td style="display:none" >
                      <div class="input-group input-group-sm">
                        <input readonly class="form-control form-control-sm" type="text" name="item_quantity[]" data-id="item_quantity" value="<?=$value->item_quantity?>" required>
                    ...
                    <div class="input-group input-group-sm">
                      ...
                      <input readonly class="form-control form-control-sm" type="number" name="item_order_quantity[]" data-id="item_order_quantity" min="1" value="<?=$value->item_quantity?>" required>
                      <input readonly class="form-control form-control-sm" type="hidden" name="item_weight[]" data-id="item_weight" readonly>
          ...
          <div class="col-lg-2 col-sm-12">
            <div class="form-group">
              ...
              <select class="custom-select" name="type_invoice" id="type_invoice" required>
                  ...
                  <option value="purchase" <?=preg_match('/^INV+\/PURCHASE/i', get('invoice'))?'selected':''?>><?=lang('purchase')?></option>
                  <option value="purchase_returns" <?=preg_match('/^RET+\/PURCHASE/i', get('invoice'))?'selected':''?>><?=lang('purchase_returns')?></option>
                  <option value="sale" <?=preg_match('/^INV+\/SALE/i', get('invoice'))?'selected':''?>><?=lang('sale')?></option>
                  <option value="sale_returns" <?=preg_match('/^RET+\/SALE/i', get('invoice'))?'selected':''?>><?=lang('sale_returns')?></option>
              </select>
              <input type="hidden" name="invoice_reference" value="<?=get('invoice')?>">
            </div>
          </div>
          <div class="col-lg-2 col-sm-12">
            <div class="form-group">

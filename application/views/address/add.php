                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <select class="form-control" style="width: 100%;" name="customer_id" id="customer_id" required>
                                    <option value="" selected><?=lang('select_store_name')?></option>
                                    <?php foreach ($customers as $key => $customer):?>
                                    <option value="<?=$customer->id?>"<?=($customer->id==GET('id'))?' selected':''?>><?=$customer->store_name?></option>
                                    <?php endforeach ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-3">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="contact_mail" id="contact_mail">
                          </div>
                        </div>

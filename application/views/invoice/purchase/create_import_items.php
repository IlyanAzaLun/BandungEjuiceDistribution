              ...
              <table class="table table-sm">
                ...
                <tbody>
                  ...
                  <tr class="input-<?=$i?>" id="main">
                    ...
                    <td style="display:none">
                      <input class="form-control form-control-sm" type="text" name="is_upload[]" data-id="is_upload" value=1 required>
                      <input class="form-control form-control-sm" type="text" name="item_capital_price_is_change[]" data-id="item_capital_price_is_change" value=0 required>

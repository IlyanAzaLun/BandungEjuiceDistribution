...
<script>
  $(function() {
    ...
    var table = $("#example2").DataTable({
      ...
      ajax: {
        "url": "<?php echo url('invoice/purchases/consignment/serverside_datatables_data_purchase_consignment') ?>",
        "type": "POST",
        "data": function(d) {
      ...
      columns: [{
        ...
        },
        {
          ...
          render: function(data, type, row) {
            ...
            return `<a target="_blank" href="${location.base}master_information/supplier/edit?id=${row['supplier_code']}">${shorttext(data, 12, true)}</a>`
          }
        },
        {
          data: "total_price",

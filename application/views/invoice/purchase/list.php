        ...
        },
        {
          ...
          render: function(data, type, row, meta) {
            ...
            if(row['have_a_child'] == null && row['is_cancelled'] == false){
              ...
              html += `
                <a href="<?= url('invoice/purchase') ?>/edit?id=${data}" class="btn btn-xs btn-default" data-toggle="tooltip" data-placement="top" title="Edit return purchasing"><i class="fa fa-fw fa-edit text-primary"></i></a>

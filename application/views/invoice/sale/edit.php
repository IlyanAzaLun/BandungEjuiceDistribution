                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-1 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="hidden" name="is_have" id="is_have" value="<?=$_data_invoice_parent->is_have?>">
                                <input type="text" name="marketing" id="marketing" class="form-control" value="<?=$this->db->get_where('users', array('id'=> $_data_invoice_parent->is_have))->row()->name?>" required>
                            </div>
                        </div>
                        <?php endif ?>
                                        ...
                                        <tr class="input-<?= $key ?>" id="main">
                                            ...
                                            <td>
                                                <div class=" input-group input-group-sm">
                                                    ...
                                                    <input class="form-control form-control-sm" type="hidden" name="item__total_weight[]" data-id="item__total_weight" value="<?=$value->item_quantity*$this->items_model->getByCodeItem($value->item_code, 'weight')?>" readonly>

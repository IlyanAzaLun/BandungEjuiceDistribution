                ...
                <?php foreach ($items as $key => $value) : ?>
                  <tr class="input-<?=$key?>" id="main">
                    ...
                    <div class="input-group input-group-sm">
                        ...
                        <input readonly class="form-control form-control-sm" type="text" name="item_order_quantity_current[]" data-id="item_order_quantity_current" min="1" required value="<?= (int)$value->item_quantity ?>" style="">
                      <div class="input-group-append">
                        <span class="input-group-text" data-id="item_unit"><?= $value->item_unit ?></span>
                      </div>
                    </div>

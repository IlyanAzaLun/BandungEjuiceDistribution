<?php foreach ($bank as $key => $value) {
    if($value->id == $invoice_sale->transaction_destination){
        $bank = $bank[$key];
    }
}?>
<?php
            ...
            <table class="table border">
                <thead>
                    <tr>
                        ...
                        <th class="text-left" colspan="3"><?=$invoice_sale->invoice_code?> </th>
                    </tr>
                    <tr>
                    <th class="text-right" colspan="3">Created at: </th>
                        <th class="text-left" colspan="3"><?=$invoice_sale->created_at?> </th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <th colspan="2" class="text-left"><?=$invoice_sale->date_start?> </th>
                        <th colspan="2" class="text-left"><?=$invoice_sale->date_due?> </th>
                    </tr>
                    <tr id="header">
                        <th  width="1%">No.</th>
                        <th>Item Code</th>
                ...
                <tbody>
                    <?php
                    $total_item = 0;
                    foreach ($list_item_sale as $key => $value):?>
                    <tr id="data">
                        <td ><?=$key+1?></td>
                ...
                <tfoot>
                    <tr>
                        ...
                        <th colspan="2" rowspan="2" class="text-left" style="vertical-align:top;"><?=$invoice_sale->note?></th>
                        <th class="text-right"><b><?=$total_item?></b></th>
                        <th colspan="3" class="text-right"><?=lang('total_price')?>: </th>
                        <th class="text-right"><?=getCurrentcy($invoice_sale->total_price)?></th>
                    </tr>
                    <tr>
                        <th colspan="4" class="text-right"><?=lang('discount')?>: </th>
                        <th class="text-right"><?=getCurrentcy($invoice_sale->discounts)?></th>
                    </tr>
                    <tr>
                        ...
                        <th class="text-right"><?=getCurrentcy($invoice_sale->shipping_cost)?></th>
                    </tr>
                    <tr>
                        <th colspan="3" class="text-left"></th>
                        <th colspan="4" class="text-right"><?=$invoice_sale->expedition?>:</th>
                        <th class="text-left"><?=$invoice_sale->services_expedition?></th>
                    </tr>
                    <tr>
                        <th colspan="2" class="text-right"></th>
                        ...
                        <th class="text-left"><?=$invoice_sale->status_payment?></th>
                    </tr>
                    <tr>
                        <th colspan="3" class="text-left"></th>
                        <th colspan="4" class="text-right"><?=lang('grandtotal')?>: </th>
                        <th class="text-right"><?=getCurrentcy($invoice_sale->grand_total)?></th>
                    </tr>
                    <tr>

...
<section class="content">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <?php echo form_open_multipart('invoice/sales/returns/edit?id=' . get('id'), ['class' => 'form-validate', 'autocomplete' => 'off']); ?>
                            ...
                            <table class="table table-sm">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="15%"><?= lang('item_order_quantity_returns') ?></th>
                                ...
                                <tbody>
                                    <?php foreach ($_data_item_invoice as $key => $value) : ?>
                                        <?php if ($value->item_code == $intersect_code_item[$key] && $value->index_list == $intersect_index_list[$key]):?>
                                            ...
                                            <td>
                                                <div class=" input-group input-group-sm">
                                                    <input class="form-control form-control-sm" type="number" name="item_order_quantity[]" data-id="item_order_quantity" min='0' max="<?=  (int)$value->item_quantity - (int)$items[$i]->item_quantity ?>" value="0" required>
                                            ...
                                            <td>
                                                <input class="form-control form-control-sm currency" type="hidden" name="total_price_current[]" data-id="total_price_current" min="0" required value="<?= $items[$i]->total_price ?>" readonly>
                                        ...
                                        <tr class="input-<?= $key ?>" id="main" style="display:none">
                                            ...
                                            <td>
                                                <div class=" input-group input-group-sm">
                                                    <input <?= ($value->total_price == 0)?'this_horiable':'' ?> class="form-control form-control-sm" type="number" name="item_order_quantity[]" data-id="item_order_quantity" max="<?= (int)$value->item_quantity ?>" value="0" required>

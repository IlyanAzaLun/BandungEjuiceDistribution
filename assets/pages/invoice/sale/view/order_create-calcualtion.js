function sum_sub_total_item(row) {
    ...
    let total_price_cap = $(`.${row} td input[data-id='total_price_cap']`);
    total_price.val(
...
function sum_cap_sub_total() {
    ...
    $('tbody>tr#main').each(function (key, value) {
        ...
        let item_order_quantity = $(`.${row} td input[data-id='item_order_quantity']`).val();
        let item_discount = $(`.${row} td input[data-id='discount']`).val();
        let total_price = $(`.${row} td input[data-id='total_price_cap']`).val();
        list_of_value.push({
            'item_code': item_code,
            'item_quantity': item_quantity,
            'item_selling_price': item_selling_price,
...
export { sum_sub_total_item, sum_sub_total_item_returns, sum_sub_total, sum_grand_total, validation_form, sum_cap_sub_total };